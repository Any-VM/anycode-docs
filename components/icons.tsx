...
export function Gitlab({ className }: IconProps) {
  return (
    <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 380 380"><defs></defs><g id="LOGO"><path d="M282.83,170.73l-.27-.69-26.14-68.22a6.81,6.81,0,0,0-2.69-3.24,7,7,0,0,0-8,.43,7,7,0,0,0-2.32,3.52l-17.65,54H154.29l-17.65-54A6.86,6.86,0,0,0,134.32,99a7,7,0,0,0-8-.43,6.87,6.87,0,0,0-2.69,3.24L97.44,170l-.26.69a48.54,48.54,0,0,0,16.1,56.1l.09.07.24.17,39.82,29.82,19.7,14.91,12,9.06a8.07,8.07,0,0,0,9.76,0l12-9.06,19.7-14.91,40.06-30,.1-.08A48.56,48.56,0,0,0,282.83,170.73Z"/></g></svg>
  )
  }
...
export const AnyVM = (props: IconProps) => (
  <svg
    width="567"
    height="601"
    viewBox="0 0 567 601"
  ...
  >
    <g filter="url(#filter0_dddddd_1_10)">
      <rect
        ...
        height="180.544"
        rx="22"
        transform="matrix(0.866025 -0.5 0 1 287 305.272)"
        fill="#82B2FA"
      />
      <rect
        x="1.73205"
    ...
    <g filter="url(#filter1_dddddd_1_10)">
      <rect
        ...
        height="180.544"
        rx="22"
        transform="matrix(0.866025 0.5 0 1 124 215)"
        fill="#82B2FA"
      />
      <rect
        x="1.73205"
    ...
    <g filter="url(#filter2_dddddd_1_10)">
      <rect
        ...
        height="180.544"
        rx="22"
        transform="matrix(0.866025 0.5 -0.866025 0.5 284.356 117)"
        fill="#82B2FA"
      />
      <rect
        y="2"
    ...
    <path
      d="M330.031 350.413L338.745 379.979L339.077 379.787L347.792 340.158L360.823 332.635L346.796 389.802L331.027 398.907L317 357.936L330.031 350.413Z"
      fill="black"
    />
    <path
      d="M364.916 330.272L379.274 321.982L389.151 344.073L389.649 343.785L399.526 310.29L413.885 302V351.069L402.597 357.586V329.218L402.265 329.41L392.803 362.857L385.997 366.786L376.535 344.073L376.203 344.264V372.824L364.916 379.341V330.272Z"
      fill="black"
    />
    <path
      d="M161.535 345.086L152 339.581L162.743 308.202L174.821 315.175L185.563 358.959L176.028 353.454L168.909 322.112L168.655 321.965L161.535 345.086ZM159.755 329.232L177.681 339.581V347.215L159.755 336.865V329.232Z"
      fill="black"
    />
    <path
      d="M216.858 339.446V377.027L209.485 372.77L197.725 346.236L197.534 346.125V365.87L188.698 360.769V323.188L196.199 327.518L207.768 353.869L208.023 354.016V334.345L216.858 339.446Z"
      fill="black"
    />
    <path
      d="M219.703 341.088L229.556 346.777L235.913 365.714L236.167 365.861L242.524 354.264L252.376 359.952L240.426 378.816V390.634L231.654 385.569V373.752L219.703 341.088Z"
      fill="black"
    />
    <path
      fillRule="evenodd"
    ...
    <defs>
      ...
      >
        ...
        />
        <feOffset />
        <feGaussianBlur stdDeviation="1.46705" />
        <feColorMatrix
          type="matrix"
          values="0 0 0 0 0.101961 0 0 0 0 0.0901961 0 0 0 0 0.0901961 0 0 0 1 0"
        />
        <feBlend
          mode="normal"
        ...
        />
        <feOffset />
        <feGaussianBlur stdDeviation="2.93409" />
        <feColorMatrix
          type="matrix"
          values="0 0 0 0 0.101961 0 0 0 0 0.0901961 0 0 0 0 0.0901961 0 0 0 1 0"
        />
        ...
        />
        <feOffset />
        <feGaussianBlur stdDeviation="10.2693" />
        <feColorMatrix
          type="matrix"
          values="0 0 0 0 0.101961 0 0 0 0 0.0901961 0 0 0 0 0.0901961 0 0 0 1 0"
        />
        <feBlend
          mode="normal"
          in2="effect2_dropShadow_1_10"
          result="effect3_dropShadow_1_10"
        />
        <feColorMatrix
          in="SourceAlpha"
          type="matrix"
        ...
        />
        <feOffset />
        <feGaussianBlur stdDeviation="20.5387" />
        <feColorMatrix
          type="matrix"
          values="0 0 0 0 0.101961 0 0 0 0 0.0901961 0 0 0 0 0.0901961 0 0 0 1 0"
        />
        <feBlend
          ...
          result="effect4_dropShadow_1_10"
        />
        <feColorMatrix
          in="SourceAlpha"
          type="matrix"
        ...
        />
        <feOffset />
        <feGaussianBlur stdDeviation="35.2091" />
        <feColorMatrix
          type="matrix"
          values="0 0 0 0 0.101961 0 0 0 0 0.0901961 0 0 0 0 0.0901961 0 0 0 1 0"
        />
        <feBlend
          mode="normal"
          in2="effect4_dropShadow_1_10"
          result="effect5_dropShadow_1_10"
        />
        <feColorMatrix
          in="SourceAlpha"
          type="matrix"
        ...
        <feBlend
          mode="normal"
          in2="effect5_dropShadow_1_10"
          result="effect6_dropShadow_1_10"
        />
        <feBlend
          mode="normal"
          in="SourceGraphic"
          in2="effect6_dropShadow_1_10"
          result="shape"
        />
      </filter>
      <filter
        id="filter1_dddddd_1_10"
        x="0.768059"
        y="100.166"
        width="402.82"
        height="500.485"
